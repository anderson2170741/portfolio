          ...
          <div className="flex flex-col md:flex-row sm:mx-14 sm:my-8 md:mx-8 md:my-8">
            ...
            <div className="md:ml-8 text-left text-white font-bold">
              ...
              <p className="mb-4 text-sm sm:text-base xl:text-lg">
                <span className="text-base sm:text-lg xl:text-xl text-yellow">Tecnologías - </span>
                React, CSS, API
              </p>
              <p className="mb-4 text-sm sm:text-base xl:text-lg">
                <span className="text-base sm:text-lg xl:text-xl text-yellow">Role - </span>Frontend
              </p>
              <a
        ...
        <div className="">
          ...
          <div className="flex flex-col md:flex-row sm:mx-14 sm:my-8 md:mx-8 md:my-8">
            ...
            <div className="md:ml-8 text-left text-white font-bold">
              ...
              <a href="https://github.com/anderson2170741/weather.git" target="_blank" rel="noopener noreferrer" className="boxIcons grid place-items-center w-7 h-7 sm:w-8 sm:h-8 xl:w-10 xl:h-10 cursor-pointer bg-grey rounded-lg">
                <FaGithub className="text-xl sm:text-2xl xl:text-3xl text-black" />
              </a>
            </div>
          </div>
